...
<div class="swiper-slide" bind:this={slideElement}>
  ...
  <div class="slide-content">
    <div class="eyebrow">
      ...
      <span>Taller · Código Sin Siesta · 2026</span>
    </div>
    ...
    <p class="subtitle">
      Markdown plano + LLM como redactor + humano como editor.<br />
...
<style>
  ...
  @media (max-width: 390px) {
    .slide-content { padding: var(--spacing-sm); gap: var(--spacing-md); }
    .title {
    ...
    .eyebrow { font-size: 0.75rem; gap: var(--spacing-xs); }
  ...
  @media (max-height: 900px) and (min-width: 769px) {
    .slide-content { padding: var(--spacing-lg) var(--spacing-content); gap: var(--spacing-lg); }
    .title { font-size: clamp(2.5rem, 7vw, 5rem); }
    .subtitle { font-size: clamp(0.95rem, 1.6vw, 1.2rem); }
    .author-card { padding: var(--spacing-md) var(--spacing-lg); }
